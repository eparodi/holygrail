...
public class Game implements Serializable {
    ...
    public boolean attemptBuildArcher() {
        ...
        boolean hasBuiltUnit = productionBuilding.buildArcher(world);
        if(hasBuiltUnit) addLog("Archer Built");
        else addLog("Cell Occupied or you dont have enough money");
        return hasBuiltUnit;
    }
    ...
    public boolean attemptBuildRider() {
        ProductionBuilding productionBuilding = world.getPlayerProductionBuilding(activePlayer);
        boolean hasBuiltUnit = productionBuilding.buildRider(world);
        if(hasBuiltUnit) addLog("Rider Built");
        else addLog("Cell Occupied or you dont have enough money");
        return hasBuiltUnit;
    }
    ...
    public boolean attemptBuildLancer() {
        ProductionBuilding productionBuilding = world.getPlayerProductionBuilding(activePlayer);
        boolean hasBuiltUnit = productionBuilding.buildLancer(world);
        if(hasBuiltUnit) addLog("Lancer Built");
        else addLog("Cell Occupied or you dont have enough money");
        return hasBuiltUnit;
    }
    ...
    /**
     * Returns all the Cells in world.
     *
